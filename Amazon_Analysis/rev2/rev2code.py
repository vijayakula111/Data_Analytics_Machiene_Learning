...
try:
        ...
        print "Didnt find user birdnest scores for %s network" % NETWORKNAME
        full_birdnest_user = [0.0]*num_users
        
try:
        full_birdnest_product = cPickle.load(open("data/%s_birdnest_product.pkl" %NETWORKNAME, "rb"))
except:
        print "Didnt find product birdnest scores for %s network" % NETWORKNAME
        full_birdnest_product = [0.0]* num_products
